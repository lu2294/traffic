...
module.exports.inject = function(obj,objType,supperType,option, ready, isForce)
{
	...
	objType.prototype.initPlay = function(reload) {
	    ...
	    {
	    	flvjs.LoggingControl.enableAll = that._options.debug;
...
},{"../../lib/dom":24,"../../lib/ua":38,"../base/event/eventtype":48}],93:[function(require,module,exports){
var playerUtil = require('../../lib/playerutil');
module.exports = [
	{
...
var FullScreenService = function(player)
{
    ...
    if (requestFullScreen) {
        Event.on(document, requestFullScreen.eventName, function(e) {
            ...
            alert('isFullScreen:' + that.isFullScreen);
...
FullScreenService.prototype.requestFullScreen = function() {
    ...
    if (requestFullScreen && !this._player._options.enableMockFullscreen) {
        alert('requestFullScreen method');
        conTag[requestFullScreen.requestFn]();
...
Component.prototype.destroy = function() {
  ...
  // 从dom中删除所有元素
  if (this._el.parentNode && this._el.id != player.id()) {
...
var ErrorDisplay = Component.extend({
  ...
  createEl: function() {
    var el = Component.prototype.createEl.call(this, 'div');
    el.innerHTML = "<div class='prism-error-content'><p></p></div><div class='prism-error-operation'>"+
    "<a class='prism-button prism-button-refresh' style='display:none'>"+lang.get('Refresh_Text')+"</a>"+
...
},{"../../../lang/index":17,"../../../lib/dom":24,"../../../lib/event":25,"../../../lib/object":32,"../../../player/base/event/eventtype":48,"./selector":120,"./util":122}],118:[function(require,module,exports){
module.exports = {
   CC :require('./cc'),
   Speed : require('./speed'),
